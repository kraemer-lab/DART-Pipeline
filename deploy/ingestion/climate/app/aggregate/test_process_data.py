...
class TestCases(unittest.TestCase):
    ...
    def test_process_gadm_chirps_data(self):
        ...
        path = Path(
            ...
            "GADM administrative map and CHIRPS rainfall data",
            "VNM",
            "Admin Level 0",
            "Rainfall.csv",
        )
    ...
    def test_process_geospatial_sociodemographic_data(self):
        data_name = ["GADM administrative map", "WorldPop population count"]
        process_geospatial_sociodemographic_data(data_name, "0", "VNM", "2020", "ppp")
        self.test_process_gadm_worldpoppopulation_data()

        data_name = ["GADM administrative map", "WorldPop population density"]
        process_geospatial_sociodemographic_data(data_name, "0", "VNM", "2020", "ppp")
