...
def test_temperature_daily_dataset(singapore_region):
    ds = temperature_daily_dataset(singapore_region, **params)
...
def test_precipitation_weekly_dataset(singapore_region):
    ds = precipitation_weekly_dataset(singapore_region, **params)
    print(ds)
...
def test_balance_weekly_dataarray(singapore_region):
    da = balance_weekly_dataarray(singapore_region, **params)
