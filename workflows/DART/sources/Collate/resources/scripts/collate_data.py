...
def walk(
    ...
    dry_run : bool, default False
        If True, the data will be downloaded. If False, no data will beAPHRODITE Daily
        mean temperature product (V1808) downloaded but, instead, empty files will be
        created in the output folder with a naming system matching that of a wet run.
    out_dir : str, default '.'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_directory", "-o", default=path.parent, help="Output directory"
    )
    parser.add_argument(
        "--creds", "-c", default="credentials.json", help="Credentials file"
    )
...
- `time python3 collate_data.py --only_one`: 6:36.88
- `time python3 collate_data.py --only_one --dry_run`: 4.144
"""
...
- `time python3 collate_data.py -n "APHRODITE Daily accumulated
...
- `time python3 collate_data.py -n "CHIRPS: Rainfall Estimates from Rain
...
- `time python3 collate_data.py -n "GADM administrative map"`: 1m0.087s
"""
